...
// 1.2. Note que uma das caixas está um pouco acima das outras. Por que isso ocorre?
    //A classe .tech possui um transform para "subir" 20pix. Apenas o bloco que possui a tech possui essa caracteristica de destaque
...
input.addEventListener('input', function(event){
    const teste = document.querySelector('.tech');
    teste.innerText = event.target.value;
});
